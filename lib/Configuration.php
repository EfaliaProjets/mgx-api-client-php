...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://mgx.loc:1906';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/canari-11/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: canari-11' . PHP_EOL;
        $report .= '    SDK Package Version: canari-11' . PHP_EOL;
