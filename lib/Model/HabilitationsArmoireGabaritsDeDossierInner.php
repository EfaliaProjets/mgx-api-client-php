<?php
/**
 * HabilitationsArmoireGabaritsDeDossierInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * HabilitationsArmoireGabaritsDeDossierInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HabilitationsArmoireGabaritsDeDossierInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HabilitationsArmoire_gabaritsDeDossier_inner';
    ...
    protected static $openAPITypes = [
        'gabarit' => 'string',
        'droits' => '\OpenAPI\Client\Model\Droit[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('droits', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['droits'] === null) {
            $invalidProperties[] = "'droits' can't be null";
        }
     ...
     * Gets droits
     *
     * @return \OpenAPI\Client\Model\Droit[]
     */
    public function getDroits()
    {
        return $this->container['droits'];
    }

    /**
     * Sets droits
     *
     * @param \OpenAPI\Client\Model\Droit[] $droits droits
     *
     * @return self
     */
    public function setDroits($droits)
    {
        ...
        if (is_null($droits)) {
            throw new \InvalidArgumentException('non-nullable droits cannot be null');
        }

        $this->container['droits'] = $droits;
