...
/**
 * InformationBannette Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InformationBannette implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InformationBannette';
    ...
    */
     ...
     *
     * @param bool|null $recherche_dans_contenu Désactiver la recherche dans le contenu n'affectera que les futurs ajout à la bannette. Ne pas spécifier cette clé ne modifiera pas la valeur de ce flag.  Il est préférable d'utiliser l'endpoint dédié à la modification de ce flag
     *
     * @return self
     * @deprecated
     */
