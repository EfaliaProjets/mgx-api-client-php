<?php
/**
 * ReponseEtatLdapConfigurationAttributs
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ReponseEtatLdapConfigurationAttributs Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReponseEtatLdapConfigurationAttributs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReponseEtatLdap_configuration_attributs';
    ...
    */
     ...
     * Sets identifiant
     *
     * @param string $identifiant Nom de l'attribut utilisté pour récupérer l'identifiant de l'utilisateur
     *
     * @return self
     */
